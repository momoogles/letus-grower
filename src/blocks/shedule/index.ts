  ...
  render() {
    const CONTENTS: {
      ...
      火: [
        ...
        [''],
        [''],
        ['応用数学研究２', 129296, 'hishu'],
        ['応用数学研究２', 129296, 'hishu'],
      ],
      水: [
        ['応用数学特別講義３', 129311, 'sentaku'],
        ['応用確率論２', 129316, 'hishusentaku'],
        [''],
        [''],
        ['Ｂ英語１ｂ', 128621, 'ippan'],
      ],
      木: [
        ['データ処理２', 129355, 'sentaku'],
        ['実験計画法２', 129341, 'sentaku'],
        ['多変量解析２', 129336, 'sentaku'],
        ['AI・数学特別講義', 143716, 'hishu'],
        ['情報処理１', 129306, 'hishusentaku'],
      ],
      金: [
        ['数理統計学４', 129318, 'hishusentaku'],
        ['技術経営概論', undefined, 'ippan'],
        ['代数学１', 129371, 'hishusentaku'],
        [''],
        [''],
      ],
    }
